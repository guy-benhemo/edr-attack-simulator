...
- **Primary flow**: "Run Full Scan" — all 9 scenarios run sequentially, automatically
...
Centered layout. Guardz logo, title "EDR Attack Simulator", one-liner description. Big green "Run Full Scan" CTA. Smaller "Or select individual tests" link below.
...
Score display: "{n}/9 Threats Detected" with SVG score ring. List of all scenarios with verdict badges. Each row expandable to show technical details (stdout/stderr/exit code). "Run Again" + "Back to Home" buttons.

### 4. Selection Screen

List of all 9 scenarios with checkboxes. "Run Selected" button. Back arrow to return to welcome.
